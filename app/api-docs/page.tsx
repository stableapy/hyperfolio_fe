...
const API_PRICING_PLAN_LIST: ApiPricingPlan[] = API_PRICING_PLANS.map((plan) => ({
  id: plan.id,
  title: plan.title,
...
export default function ApiDocsPage() {
  return (
    <div className="bg-theme-bg min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <p className="text-theme-text-secondary mx-auto mb-10 max-w-2xl font-mono text-base leading-relaxed sm:text-lg">
            Build powerful applications on HyperEVM with our comprehensive REST
            API. Access wallet data, token information, NFT collections, and
            DeFi positions.
          </p>
          ...
          <p className="text-theme-text-muted mt-6 font-mono text-xs sm:text-sm">
            ...
            <Link href="/billing" className="text-theme-accent hover:underline">
              /billing
            </Link>
          </p>
        </div>
      ...
      <section id="api-pricing" className="border-theme-border/30 border-t py-16">
        <div className="container mx-auto px-6">
          <h2 className="mb-12 text-center font-mono">
            <span className="text-theme-text-muted text-sm">&gt; billing</span>
            <span className="text-theme-text ml-2 text-2xl font-bold md:text-3xl">
              --pricing
            </span>
          </h2>

          <div className="mx-auto mb-6 grid max-w-6xl grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
