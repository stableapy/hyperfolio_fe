...
ARG NEXT_PUBLIC_STRIPE_PRICE_SOLO_DISPLAY
ARG NEXT_PUBLIC_STRIPE_PRICE_STARTER_DISPLAY
ARG NEXT_PUBLIC_STRIPE_PRICE_GROWTH_DISPLAY
ARG NEXT_PUBLIC_STRIPE_PRICE_SCALE_DISPLAY
ARG NEXT_PUBLIC_STRIPE_PRICE_INTERVAL
...
ENV NEXT_PUBLIC_STRIPE_PRICE_SOLO_DISPLAY=$NEXT_PUBLIC_STRIPE_PRICE_SOLO_DISPLAY
ENV NEXT_PUBLIC_STRIPE_PRICE_STARTER_DISPLAY=$NEXT_PUBLIC_STRIPE_PRICE_STARTER_DISPLAY
ENV NEXT_PUBLIC_STRIPE_PRICE_GROWTH_DISPLAY=$NEXT_PUBLIC_STRIPE_PRICE_GROWTH_DISPLAY
ENV NEXT_PUBLIC_STRIPE_PRICE_SCALE_DISPLAY=$NEXT_PUBLIC_STRIPE_PRICE_SCALE_DISPLAY
ENV NEXT_PUBLIC_STRIPE_PRICE_INTERVAL=$NEXT_PUBLIC_STRIPE_PRICE_INTERVAL
