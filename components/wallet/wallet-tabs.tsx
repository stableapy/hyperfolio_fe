  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        type="button"
        onClick={onAddWallet}
        className="px-4 py-2 rounded-lg font-mono text-sm border border-dashed border-theme-cyan text-theme-cyan hover:bg-theme-cyan/10 transition-all flex items-center gap-2"
      >
