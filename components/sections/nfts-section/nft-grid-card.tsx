  ...
  return (
    <TerminalCard className="group cursor-pointer hover:border-[#00ff41] transition-all">
      ...
      <div className="p-2 sm:p-3 space-y-1.5 sm:space-y-2">
        <div>
          <div className="font-mono text-[11px] sm:text-xs text-[#00ff41] font-semibold mb-0.5 truncate">
            {nft.name}
          </div>
          <div className="font-mono text-[9px] sm:text-[10px] text-[#708090] truncate">
            {nft.collection}
          </div>
        </div>
        <div className="flex items-center justify-between pt-1.5 sm:pt-2 border-t border-[#1a2225]">
          <div>
            ...
            <div className="font-mono text-[10px] sm:text-xs text-white">
