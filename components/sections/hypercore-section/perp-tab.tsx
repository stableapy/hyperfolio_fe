  ...
  return (
    <div className="text-center py-8 sm:py-12">
      ...
      <div className="font-mono text-xs sm:text-sm text-theme-text-muted mb-4">
        <span className="text-[#00d9ff]">&gt;</span> hypercore --perp returns empty
      </div>
      ...
      <div className="inline-flex items-center bg-theme-card-bg border border-theme-border/70 rounded-sm overflow-hidden">
        <div className="px-2 py-1.5 bg-[#00d9ff]/10 border-r border-[#00d9ff]/20">
          <span className="font-mono text-[10px] sm:text-xs font-bold text-[#00d9ff]">$</span>
        </div>
        <div className="flex items-center gap-1.5 px-2.5 py-1.5">
          <span className="font-mono text-[10px] text-theme-text-muted">--margin</span>
          <span className="font-mono text-xs sm:text-sm font-bold text-[#00d9ff] tabular-nums">
            ${margin.toFixed(2)}
          </span>
        </div>
      </div>
