...
export const KYBERSWAP_NATIVE_TOKEN = "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"
 ...
 */
export function calculateTotals(tokens: Token[]): { totalValue: number; tokenCount: number } {
